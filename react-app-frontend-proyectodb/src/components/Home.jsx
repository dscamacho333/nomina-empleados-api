            ...
            <li style={styles.navItem} onClick={toggleDropdownGestion}>
              ...
              <ul style={showDropdownGestion ? styles.dropdown : styles.dropdownHidden}>
                <li>
                  <Link
                    to="/dependencias"
                    style={hoveredLink === 'dependencias' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/arl"
                    style={hoveredLink === 'arl' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/cargos"
                    style={hoveredLink === 'cargos' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/eps"
                    style={hoveredLink === 'eps' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/empleado"
                    style={hoveredLink === 'empleado' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/pension"
                    style={hoveredLink === 'pension' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/novedad"
                    style={hoveredLink === 'novedad' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/incapacidad"
                    style={hoveredLink === 'incapacidad' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/vacaciones"
                    style={hoveredLink === 'vacaciones' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
            ...
            <li style={styles.navItem} onClick={toggleDropdownReportes}>
              ...
              <ul style={showDropdownReportes ? styles.dropdown : styles.dropdownHidden}>
                <li>
                  <Link
                    to="/reporte1"
                    style={hoveredLink === 'reporte1' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                ...
                <li>
                  <Link
                    to="/reporte2"
                    style={hoveredLink === 'reporte2' ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
