        ...
        <nav>
          <ul style={styles.nav}>
            ...
            <li style={styles.navItem} onClick={toggleDropdownGraficos}>
              Gráficos
              <ul style={showDropdownGraficos ? styles.dropdown : styles.dropdownHidden}>
                <li>
                  <Link to="/dashboard" style={hoveredLink === "dashboard" ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
            ...
            {/* Reportes Formulario Dropdown Menu */}
            <li style={styles.navItem} onClick={toggleDropdownReportesFormulario}>
              Consultas
              <ul style={showDropdownReportesFormulario ? styles.dropdown : styles.dropdownHidden}>
                <li>
                  <Link to="/formularioReportes" style={hoveredLink === "formularioReportes" ? { ...styles.dropdownItem, ...styles.dropdownItemHover } : styles.dropdownItem}
                    onMouseEnter={() => handleMouseEnter("formularioReportes")}
                    onMouseLeave={handleMouseLeave}>
                    Reporte de Nómina
                  </Link>
                </li>
...
export default NavBarReporteNomina;
