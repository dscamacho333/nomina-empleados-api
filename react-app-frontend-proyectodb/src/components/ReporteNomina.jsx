  ...
  return (
    <>
          ...
          <ul style={styles.nav}>
            <li style={styles.navItem} onClick={toggleDropdownGestion}>
              ...
              >
                <li>
                  <Link
                    to="/dashboard" // Cambia a la ruta de Dashboard
                    style={
            ...
            <li style={styles.navItem} onClick={toggleDropdownReportes}>
              ...
              >
                <li>
                  <Link
                    to="/formularioReportes" // Cambia a la ruta de FormularioReportes
                    style={
                      hoveredLink === "formularioReportes"
                        ? { ...styles.dropdownItem, ...styles.dropdownItemHover }
                        : styles.dropdownItem
                    }
      ...
      <div style={{ marginTop: "100px", padding: "20px", textAlign: "center" }}>
        <h2>Bienvenido al Reporte de Nómina</h2>
        <p>Aquí va el contenido específico para el Reporte de Nómina...</p>
      </div>
    </>
  );
}
